from TravelAgents import guide_expert, logistics_expert, planner_expert
...
if st.button("🚀 Generate Travel Plan"):
    if not from_city or not destination_city or not date_from or not date_to or not interests:
        ...
        # Initialize Tasks
        loc_task = location_task(logistics_expert, from_city, destination_city, date_from, date_to)
        ...
        # Define Crew
        crew = Crew(
            agents=[logistics_expert, guide_expert, planner_expert],
